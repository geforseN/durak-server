import { Namespace as SocketIONamespace, Socket as SocketIOSocket } from "socket.io";
...
export namespace DurakGameSocket {
  ...
  export type ServerToClientEvents = {
    ...
    "player__allowedToMove": (playerId: string, timeEnd: number, moveTime: number) => void;
    ...
    "desk__clear": () => void;
    "desk__cardReceive": (card: CardDTO, slotIndex: number, whoId: string) => void;
